        ...
        <div id="exampleModal" class="reveal-modal">
            ...
            <div id="sqm-woocommerce-create-account-step-1" class="sqm-woocommerce-create-account-step">
                    ...
                    <div class="box" >
                        ...
                        <div class="box " >
                            <a id="sqm-woocommerce-create-account-next" class="button button-primary whitebtn tab-content-submit"><?php esc_html_e('Next Step', 'squalomail-for-woocommerce'); ?></a>
            ...
            <div id="sqm-woocommerce-create-account-step-2" class="sqm-woocommerce-create-account-step">
                <fieldset>
                    ...
                    <div class="box box-half" >
                        <a id="sqm-woocommerce-create-account-prev" class="button button-primary whitebtn tab-content-submit"><?php esc_html_e('Go Back', 'squalomail-for-woocommerce'); ?></a>
                    </div>
                    
                    <div class="box box-half" >
                        <a id="sqm-woocommerce-create-account-go" class="button button-primary tab-content-submit"><?php esc_html_e('Get Started!', 'squalomail-for-woocommerce'); ?></a>
