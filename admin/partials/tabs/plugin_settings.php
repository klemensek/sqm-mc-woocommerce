	...
	<div class="box">
		<label for="<?php echo $this->plugin_name; ?>-newsletter-checkbox-label">
			...
			<p>
				<?= 
				sprintf(
					__('Disconnect your store from MailChimp. This action will remove all entries from the database but you will be able to reconnect anytime.', 'squalomail-for-woocommerce'),
					$admin_email
				);?>
			</p>
		</label>
