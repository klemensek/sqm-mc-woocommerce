...
<div class="sync-content-wrapper">
    ...
    <div class="box box-half">
        <div class="sync-stats-wrapper overview-stats-store">
            <div class="box">
                <strong><?php esc_html_e('Account Connected', 'squalomail-for-woocommerce');?>:</strong> <?php echo $account_name; ?>
            </div> 
            <div class="box">
                <strong><?php esc_html_e('Audience Connected', 'squalomail-for-woocommerce');?>:</strong> <?php echo $squalomail_list_name; ?>
            </div> 
        </div>
    </div>
    ...
    <div class="box box-half">
        ...
        <div class="sync-stats-wrapper last-updated">
            ...
            <div class="box" >   
                <strong><?php esc_html_e('Last Updated:', 'squalomail-for-woocommerce');?></strong>
    ...
    <div class="box box-half resync-container">
        <div class="content ">
            ...
            <p id="resync_data_help_text">
                <?php esc_html_e('You can safely resync your audience at any time without losing any of your e-commerce data.', 'squalomail-for-woocommerce');?>
            </p>
            <?php if ($show_resync) : ?>
                <?php submit_button(__('Resync now', 'squalomail-for-woocommerce'), 'primary sqm-woocommerce-resync-button','submit', TRUE); ?>
            <?php else : ?>
                <?php submit_button(__('Resync now', 'squalomail-for-woocommerce'), 'sqm-woocommerce-resync-button','submit', TRUE, ['disabled' => true]); ?>
    ...
    <div id="exampleModal" class="reveal-modal">
        ...
        <div id="sqm-woocommerce-create-account-step-1" class="sqm-woocommerce-create-account-step tab-content-wrapper" >
            <fieldset >
                ...
                <div class="box">
                    <a id="sqm-woocommerce-support-form-submit" class="button button-primary whitebtn tab-content-submit"><?php esc_html_e('Send', 'squalomail-for-woocommerce'); ?></a>
